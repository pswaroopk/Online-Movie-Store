...
if ($movie_category == 'All'){
    $query = "SELECT * FROM movies WHERE movie_flag=1 AND id >=".$limit." order by id" ;
}
else{
    $query = "SELECT * FROM movies WHERE movie_flag=1 AND Category ='$movie_category' AND id >=".$limit." order by id"  ;
}
