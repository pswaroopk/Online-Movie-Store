...
(1, 'Avatar', 'english', 'avatar_movie.jpg', '2015', 100, 'A paraplegic marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home.'),
(2, 'Black Swan', 'english', 'black-swan.jpg', '2015', 312, 'A committed dancer wins the lead role in a production of Tchaikovskys Swan Lake only to find herself struggling to maintain her sanity.'),
(3, 'Coraline', 'english', 'Coraline.jpg', '2015', 200, 'An adventurous girl finds another world that is a strangely idealized version of her frustrating home, but it has sinister secrets.'),
(4, 'Eclipse', 'english', 'Eclipse.jpg', '2018', 100, 'As a string of mysterious killings grips Seattle, Bella, whose high school graduation is fast approaching, is forced to choose between her love for vampire Edward and her friendship with werewolf Jacob.'),
(5, 'New Moon', 'english', 'New-Moon.jpg', '2015', 213, 'Edward leaves Bella after an attack that nearly claimed her life, and in her depression she falls into yet another paranormal relationship - this time with werewolf Jacob Black.'),
(53, 'End Game', 'english', 'end-game.jpg', '2005', 620, 'A secret Service agent and a news reporter investigate the conspiracy behind the assassination of the President.'),
...
(55, 'Unstoppable', 'english', 'Unstoppable.jpg', '2004', 600, 'With an unmanned, half-mile-long freight train barreling toward a city, a veteran engineer and a young conductor race against the clock to prevent a catastrophe.'),
